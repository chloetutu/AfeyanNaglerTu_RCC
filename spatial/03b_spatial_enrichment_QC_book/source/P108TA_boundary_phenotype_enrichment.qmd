# 108TA Boundary: Phenotype enrichment {#sec-clone-enrichment-qc}
...
P108TA_26_RNA <- remove_perimeter_beads_completely(P108TA_26_RNA, "Boundary")
P108TA_29_RNA <- remove_perimeter_beads_completely(P108TA_29_RNA, "Boundary")
P108TA_30_RNA <- remove_perimeter_beads_completely(P108TA_30_RNA, "Boundary")
P108TA_32_RNA <- remove_perimeter_beads_completely(P108TA_32_RNA, "Boundary")
```
...
for(phenotype in P108TA_filtered_phenotypes){
  ...
  boundary_results <- enrichment_permutation_test(P108TA_phenotypeX_md, n_perm = n_perm, clonotype = phenotype)
...
names(boundary_phenotype_results.list) <- P108TA_filtered_phenotypes
```
...
## Save objects
```{r}
saveRDS(boundary_phenotype_results.list, "../objects/P108TA_boundary_phenotype_list_perimeter_removed.rds")
```
