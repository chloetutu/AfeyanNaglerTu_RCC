# 108TA Boundary: Clone enrichment {#sec-clone-enrichment-qc}
...
In other words, enrichment = (fraction of TCR_X in the boundary) / (fraction of all other clones in the boundary) - 1s

## Remove one layer of beads surrounding the boundary
```{r}
# Remove empty area
...
## Save object
```{r}
saveRDS(boundary_clone_results.list, "../objects/P108TA_boundary_clone_list_perimeter_removed.rds")
```
