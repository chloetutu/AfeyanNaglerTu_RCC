# 108TA TLS: Phenotype enrichment {#sec-clone-enrichment-qc}
...
P108TA_26_RNA <- remove_perimeter_beads_completely(P108TA_26_RNA, "TLS")
P108TA_29_RNA <- remove_perimeter_beads_completely(P108TA_29_RNA, "TLS")
P108TA_30_RNA <- remove_perimeter_beads_completely(P108TA_30_RNA, "TLS")
P108TA_32_RNA <- remove_perimeter_beads_completely(P108TA_32_RNA, "TLS")
```
...
## Save objects
```{r}
saveRDS(TLS_phenotype_results.list, "../objects/P108TA_TLS_phenotype_list_perimeter_removed.rds")
```
